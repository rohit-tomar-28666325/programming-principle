...
void LibraryManager::start() {
    ...
    do {
        ...
        // this is a tempory fix to load data dynamically when server running on 
        // different console. Because of In-memory data, data is not shared between
        // different console. So, we need to load data dynamically when server is running.
        // loadData();
